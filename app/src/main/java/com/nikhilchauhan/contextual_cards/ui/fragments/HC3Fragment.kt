...
import com.nikhilchauhan.contextual_cards.databinding.FragmentHC3Binding
...
class HC3Fragment : Fragment() {
  private var _binding: FragmentHC3Binding? = null
  private val binding
    get() = _binding
  ...
  override fun onCreateView(
    ...
    _binding = FragmentHC3Binding.inflate(layoutInflater, container, false)
