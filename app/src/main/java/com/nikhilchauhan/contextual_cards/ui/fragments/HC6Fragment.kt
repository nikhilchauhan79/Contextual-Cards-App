...
import com.nikhilchauhan.contextual_cards.databinding.FragmentHC6Binding
...
class HC6Fragment : Fragment() {
  private var _binding: FragmentHC6Binding? = null
  private val binding
    get() = _binding
  ...
  override fun onCreateView(
    ...
    _binding = FragmentHC6Binding.inflate(layoutInflater, container, false)
