...
import com.nikhilchauhan.contextual_cards.databinding.FragmentHC9Binding
...
class HC9Fragment : Fragment() {
  private var _binding: FragmentHC9Binding? = null
  private val binding
    get() = _binding
  ...
  override fun onCreateView(
    ...
    _binding = FragmentHC9Binding.inflate(layoutInflater, container, false)
